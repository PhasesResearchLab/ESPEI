...
#. Regenerate the API documentation with ``sphinx-apidoc -of docs/api/ espei/``. Rename the ``docs/api/modules`` title to ``API Documentation``.
...
#. Condense the change list into something user-readable. Update and commit CHANGES.rst with the release date. Propagate CHANGES to docs/``
