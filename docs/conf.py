...
# -*- coding: utf-8 -*-
#
# ESPEI documentation build configuration file, created by
...
espei_version = re.sub(r'\.d[0-9]{8}', '', espei_version)
...
version = espei_version
# The full version, including alpha/beta/rc tags.
release = espei_version
...
# of the sidebar.
html_logo = '_static/ESPEI-logo-withtext@200px.png'
...
# The name of an image file (relative to this directory) to place at the top
# of the sidebar.
latex_logo = '_static/ESPEI-logo-withtext.png'
...
latex_documents = [
    (master_doc, 'ESPEI.tex', 'ESPEI Documentation',
     'Brandon Bocklund', 'manual'),
]
...
man_pages = [
    (master_doc, 'espei', 'ESPEI Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ESPEI', 'ESPEI Documentation',
     author, 'ESPEI', 'One line description of project.',
     'Miscellaneous'),
]
