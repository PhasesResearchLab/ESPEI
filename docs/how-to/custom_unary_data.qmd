...
1.  Standard element reference (SER) data, giving the stable phase, atomic
...
3.  Optional lattice stability functions for selected phases, often
    relative to the standard element reference energy
...
[`generate_parameters` heading in ESPEI's YAML input](../reference/yaml_input_schema.qmd#generate_parameters). If you have ESPEI installed already, you can test that this
works by:
