...
[ESPEI GitHub repository](https://github.com/phasesresearchlab/espei) in the [Cu-Mg example directory](https://github.com/phasesresearchlab/espei/tree/master/docs/tutorials/cu-mg-example).
...
[GitHub](https://github.com/phasesresearchlab/espei/tree/master/docs/tutorials/cu-mg-example)):
...
mcmc_results = np.load("mcmc-results.npz")
