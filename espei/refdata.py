...
[(('AG', 'BCC_A2'), Piecewise((-1.05*T + Symbol('GHSERAG') + 3400, And(T < 3000.0, T >= 298.15)))),
 ...
 (('CU', 'LAVES_C15'), Piecewise((Symbol('GHSERCU') + 5000, And(T < 1357.77, T >= 298.15)),
                                 (Symbol('GHSERCU') + 5000, And(T < 3200.0, T >= 1357.77)))),
 ...
 (('MG', 'LAVES_C15'), Piecewise((Symbol('GHSERMG') + 5000, And(T < 923.0, T >= 298.15)),
                                 (Symbol('GHSERMG') + 5000, And(T < 3000.0, T >= 923.0)))),
